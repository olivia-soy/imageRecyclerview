...
class VerticalImageAdapter(var activity: Activity, context: Context) : BaseAdapter<BaseItem>(context) {

    companion object {
        private val TAG = VerticalImageAdapter::class.java.simpleName
    ...
    class ImageAddViewHolder(adapter: BaseAdapter<*>, itemView: View) :
        ...
        private var mActivity = (adapter is VerticalImageAdapter).run{(adapter as VerticalImageAdapter).activity}
